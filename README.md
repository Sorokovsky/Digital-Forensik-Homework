...
### 4.2 - Створення кейсу у Autopsy
Час виконання 16:03
Створюємо новий кейс
![](./images/create_case.png)

Вказкємо додаткову інформацію
![](./images/add_info.png)

Додаємо джерело даних
![](./images/add_data_source.png)

Додаємо модулі до кейсу(у навчальних цілях обрані всі)
![](./images/add_modules.png)

Отриманний зліпок даних у Autopsy
![](./images/snapshot.png)

### 4.3 - Аналіз артифактів "Recent Documents"
Час виконання 16:06
...
### 4.5 - Детальний аналіз артефактів реєстру (Evidence Submission)
...
### 4.6 - Аналіз папки C:\Windows\Prefetch
Час виконання: 17:01
